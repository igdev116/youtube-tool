...
export declare class YoutubeChannelService {
    ...
    addChannelsBulk(channels: BulkChannelDto[], userId: string, groupIds?: string[]): {
        error: boolean;
        message: string;
        docs: never[];
    };
    ...
    getUserChannelsWithPagination(userId: string, page: number, limit: number, keyword?: string, sortKey?: YoutubeChannelSort, favoriteOnly?: boolean): Promise<import("../../types/common.type").PagingResponseV2<YoutubeChannelDocument> | {
        result: {
            content: (import("mongoose").FlattenMaps<YoutubeChannelDocument> & Required<{
    ...
    addChannelToGroup(userId: string, channelDbId: string, groupId: string): Promise<(import("mongoose").Document<unknown, {}, YoutubeChannelDocument, {}> & YoutubeChannel & import("mongoose").Document<unknown, any, any, Record<string, any>> & {
        user: Types.ObjectId | import("../../user/user.schema").User;
    } & Required<{
        _id: unknown;
    }> & {
    ...
    removeChannelFromGroup(userId: string, channelDbId: string, groupId: string): Promise<(import("mongoose").Document<unknown, {}, YoutubeChannelDocument, {}> & YoutubeChannel & import("mongoose").Document<unknown, any, any, Record<string, any>> & {
        user: Types.ObjectId | import("../../user/user.schema").User;
    } & Required<{
        _id: unknown;
    }> & {
